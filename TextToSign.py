...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Text to Sign"))
    ...
    def SearchSign(self):
        sign = self.search.text()
        sign = sign.lower()
        print(sign)
        ans = dict.get(sign)
        print(ans)
        if(ans != None):
            self.label.setPixmap(QtGui.QPixmap(ans))
        else: 
            self.label.setPixmap(QtGui.QPixmap('images/None.jpg'))
